...
public class Vendedor extends Pessoa {
    ...
    public static Vendedor criarVendedor(String nomeCompleto, String cpf, int idade, String endereco, String email,
            double comissao) {
    ...
    public void atualizarVendedor(String nomeCompleto, String cpf, int idade, String endereco, String email,
        double comissao) {
